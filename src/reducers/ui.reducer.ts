...
export const UIReducer = (state: IUIState = initialUIState, action: IUIAction): IUIState => {
  ...
  switch (action.type) {
    ...
    case 'UI/OPEN_SYNC':
      ...
      return { ...state, divider: state.divider !== 0 ? 60 : 0, containers: newContainers };
    case 'UI/OPEN':
    ...
    case 'UI/OPEN_CARD':
      ...
      return { ...state, divider: customDivider, /*containers: newContainers3,*/ card: action.payload, prevCards };
    ...
    case 'UI/OPEN_ALL_RELATIONS':
      ...
      return { ...state, divider: customDivider, containers: allRelationsContainer, allRelations: action.payload };
    case 'UI/ADD_MENU_ID':
