...
export class LocalizeService {
  ...
  constructor() {
    const browserLang: string = (navigator.language || navigator.userLanguage).toUpperCase();
    if (this.texts[browserLang] != null) {
      this.language = browserLang.substr(0, 2).toUpperCase() as AvailableLanguages;
    } else {
      this.language = 'EN';
    }
