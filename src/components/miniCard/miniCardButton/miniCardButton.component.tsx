...
export class MiniCardButtonClass extends React.PureComponent<MiniCardButtonProps, {}> {
    ...
    public render() {
        switch (this.props.type) {
            case 'MORE':
                return <div className="miniCardButton fillParent more customBtn" onClick={this.props.clickAction}>+</div>;
            case 'SAVE':
                ...
                return <div className="miniCardButton fillParent customBtn" onClick={this.props.clickAction}>
                    <span className={classesApplied}></span>
                    {this.props.liked ? Localize('CAROUSEL_CARD_SAVED') : Localize('CAROUSEL_CARD_SAVE')}
                </div>;

            default:
                return <div className="miniCardButton fillParent customBtn" onClick={this.props.clickAction}></div>;
        }
